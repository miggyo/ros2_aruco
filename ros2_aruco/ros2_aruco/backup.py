    ...
    def image_callback(self, img_msg):
        ...
        if marker_ids is not None:
            ...
            for i, marker_id in enumerate(marker_ids):
                ...
                aruco_pose.position.x = tvecs[i][0][0]
                ...
                aruco_pose.id = int(marker_id[0])

                pose_array.aruco_pose.append(aruco_pose)
                pose_array.count = len(marker_ids)
